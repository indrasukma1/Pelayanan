                        ...
                        <div class="body">
                            <div class="table-responsive">
							 <table id="example" class="table table-bordered table-striped table-hover dataTable js-exportable">
								...
								<tbody>
									<?php
										$select = "SELECT tbl_krs.kode_prodi, tbl_prodi.nama_prodi, tbl_krs.semester, tbl_krs.kode_kelas, tbl_krs.tahun_akademik,
													tbl_detail_krs.kode_matakuliah, tbl_matakuliah.matakuliah, tbl_detail_krs.SKS, 
													tbl_detail_krs.kode_dosen, tbl_detail_kelas.NPM, tbl_mahasiswa.Nama 
													FROM tbl_krs 
													INNER JOIN tbl_prodi ON tbl_krs.kode_prodi=tbl_prodi.kode_prodi
													INNER JOIN tbl_detail_krs ON tbl_krs.kode_krs=tbl_detail_krs.kode_krs 
													...
													WHERE kode_dosen='$user' ORDER BY Nama ASC";
									...
									<tr>
										...
										<a href="index.php?halaman=view-detailNilai&matkul=<?php echo $data['matakuliah']; ?>&semester=<?php echo $data['semester']; ?>&tahun_akademik=<?= $data['tahun_akademik'];?>&kode_matkul=<?php echo $data['kode_matakuliah']; ?>&npm=<?php echo $data['NPM']; ?>&mhs=<?php echo $data['Nama']; ?>&sks=<?php echo $data['SKS'];?>" class="btn btn-info btn-sm">Lihat Nilai</a>
										</td>
									</tr>
									<?php 
										$no++; 
