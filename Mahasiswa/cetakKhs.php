<?php
	...
	//header("Content-Disposition: attachment; filename=Data KHS  ".$username.".xls");
	...
	$select1 = "SELECT tbl_detail_kelas.kode_prodi, tbl_detail_kelas.kode_kelas, tbl_detail_kelas.NPM, tbl_mahasiswa.Nama, tbl_prodi.kode_prodi, tbl_prodi.nama_prodi,
				...
				WHERE tbl_detail_kelas.NPM='$username' AND semester='$semester'";
										...
										<tbody>
											<?php
												$select = "SELECT * FROM tbl_nilai
															...
															WHERE NPM='$username' AND semester='$semester' ORDER BY semester ASC";
